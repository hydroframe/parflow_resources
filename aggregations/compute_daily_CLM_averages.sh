#!/bin/bash
#SBATCH --job-name=daily_agg_clm    # create a short name for your job
#SBATCH --output=clm-%A.%a.out # stdout file
#SBATCH --error=clm-%A.%a.err  # stderr file
...
python compute_daily_CLM_averages.py
